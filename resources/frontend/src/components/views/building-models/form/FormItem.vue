            ...
            <div class="form-group">
                ...
                <div class="row col-xs-12 col-sm-12">
                    <div class="col-xs-12 col-md-4">
                        <label for="width" class="control-label">Width (ft)</label>
                        <input id="width" type="number" class="form-control" v-model="curItem.width">
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <label for="length" class="control-label">Length (ft)</label>
                        <input id="length" type="number" class="form-control" v-model="curItem.length">
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <label for="wallHeight" class="control-label">Wall Height (ft)</label>
                ...
                return Promise.all(datas)
                    .then(response => {
                        if (dep === null) {
                            ...
                            this.styles = response[1].data.data
